...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    description:
      'Полный расчёт — экран «Высота рабочего стола» (из умного офиса). В «Шаги» → Настройки блок «Умный стол» показывает высоты без перехода. Рост и вес — в полях выше.',
    icon: 'tune',
    questions: [
  ...
  },
  {
    ...
    icon: 'home',
    questions: [
      'Что такое «умный офис» в WorkFlow?',
