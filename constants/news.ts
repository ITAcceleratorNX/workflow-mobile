...
export const NEWS_ITEMS: NewsItem[] = [
  ...
  { id: '2', tag: 'Умный офис', title: 'Экономия энергии', desc: 'Ваши умные устройства экономят энергию, синхронизируясь с расписанием.', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600', date: '' },
  ...
  { id: '5', tag: 'Умный офис', title: 'Автоматизация освещения', desc: 'Настройте сценарии освещения под время суток для комфорта глаз.', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600', date: '' },
  ...
  { id: '8', tag: 'Умный офис', title: 'Климат-контроль', desc: 'Оптимальная температура в помещении: 20–22°C для продуктивности.', image: 'https://images.unsplash.com/photo-1620121692029-d088224ddc74?w=600', date: '' },
].map((item, i) => {
  const d = new Date();
